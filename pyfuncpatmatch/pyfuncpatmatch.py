...
from pyfuncpatmatch.PatDecoratorClass import PatDecoratorClass
...
def patfunc(
    ...
    ```
    will call the first lambda that return 0 if the first argument of
     fib_rec (n) is equal to 0
    will call the first lambda that return 1 if the first argument of
     fib_rec (n) is equal to 1
